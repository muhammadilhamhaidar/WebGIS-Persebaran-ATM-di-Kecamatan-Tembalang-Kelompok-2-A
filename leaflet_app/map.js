...
$(document).ready(function() {
    $.ajax({
        type: "GET",
        url: "http://localhost:8080/geoserver/Persebaran_ATM_di_Kecamatan_Tembalang/wfs?request=getCapabilities",
        dataType: "xml",
...
$(function () {
    $("#attributes").change(function () {
        ...
        operator.options[0] = new Option('Select Data', "");
        //alert(value_attribute);
        //alert(value_layer);
        $(document).ready(function () {
            $.ajax({
                type: "GET",
                url: "http://localhost:8080/geoserver/wfs?service=WFS&request=GetFeature&version=1.1.0&typeName=" + value_layer + "&outputFormat=application/json",
                dataType: "json",
...
function query() {
	...
	var value_attribute1 = $('#attributes option:selected').val();
    //alert(value_attribute);

    var operator = document.getElementById("operator");
	var value_operator1 = $('#operator').val();
    ...
    var url = "http://localhost:8080/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=" + value_layer + "&CQL_FILTER=" + value_attribute + "%20=%20" + "'" + value_operator + "'" + "&outputFormat=application/json"
    //console.log(url);
...
function wms_layers() {
  ...
  $("#wms_layers_window").modal('show');
    ...
    $(document).ready(function() {
        $.ajax({
            type: "GET",
            url: "http://localhost:8080/geoserver/Persebaran_ATM_di_Kecamatan_Tembalang/wms?request=getCapabilities",
            dataType: "xml",
            success: function(xml) {
